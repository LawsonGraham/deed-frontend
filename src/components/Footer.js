...
export default function Nav() {
    return (
        ...
        <footer class="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://tetraecosystems.com" class="hover:underline" target="_blank">TETRA Ecosystems™</a>. All Rights Reserved.
        </span>
